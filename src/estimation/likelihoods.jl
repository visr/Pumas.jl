...
function _orth_empirical_bayes!(
  ...
  subject::Subject,
  param::NamedTuple,
  approx::Union{FOCEI,Laplace,LaplaceI},
  args...;
...
function _marginal_nll(_dv_∂²l∂η², vrandeffsorth, approx::Union{FOCEI,Laplace,LaplaceI})
  nl, _, W = _dv_∂²l∂η²
  if isfinite(nl)
...
# Similar to the version for FOCEI, Laplace, and LaplaceI
