...
@test DepotCentral1().syms == (:Depot, :Central)
@test Pumas.DiffEqBase.has_syms(DepotCentral1())
@test TwoDepotsCentral1().syms == (:Depot1, :Depot2, :Central)
@test Pumas.DiffEqBase.has_syms(TwoDepotsCentral1())
...
ocm = Pumas.LinearAlgebra.eigen(DepotCentral1(), p)
...
ocm = Pumas.LinearAlgebra.eigen(Central2(), p)
λ1 = -(17+sqrt(249))/40
λ2 = -(17-sqrt(249))/40
...
ocm = Pumas.LinearAlgebra.eigen(DepotCentral2(), p)
λ1 = -(17+sqrt(249))/40
λ2 = -(17-sqrt(249))/40
...
ocm = Pumas.LinearAlgebra.eigen(Metabolite22(), p)
